...
import { FactCheck, Group, Groups, School } from "@mui/icons-material"
  ...
  return (
    <>
      <Grid container justifyContent="space-between" spacing={5}>
        {
          [
            { title: 'Estudiantes', value: "273", icon: <Group fontSize="large" />, color: red },
            { title: 'Maestros', value: "10", icon: <Group fontSize="large" />, color: green },
            { title: 'Asignaturas', value: "110", icon: <Group fontSize="large" />, color: orange },
...

        {
          [
            ...
            { icon: <School sx={{fontSize: 50}} />, title: 'Calificaciones', route: PrivRoutes.GRADES },
            { icon: <GradeFilled sx={{fontSize: 50}} />, title: 'Configuración', route: PrivRoutes.SETTINGS },
          ].map((item) => <Grid item xs={12} sm={2}>
